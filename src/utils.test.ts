...
describe('Util Tests', () => {
  ...
  describe('test getPrescriptionTableActiveMedicationRequestsEndpoint', () => {
    test('should return endpoint without date parameter for active status', () => {
      expect(getPrescriptionTableEndpoint('', 'ACTIVE', 1, 10, '2020-01-01', null, null)).toBe(
        '/ws/fhir2/R4/Encounter?_query=encountersWithMedicationRequests&_getpagesoffset=1&_count=10&status=ACTIVE',
      );
    });
    test('should return endpoint without date but with search term parameters', () => {
      expect(getPrescriptionTableEndpoint('', 'ACTIVE', 1, 10, '2020-01-01', 'bob', null)).toBe(
        '/ws/fhir2/R4/Encounter?_query=encountersWithMedicationRequests&_getpagesoffset=1&_count=10&status=ACTIVE&patientSearchTerm=bob',
      );
    });
    test('should return endpoint without date but with location parameters', () => {
      expect(getPrescriptionTableEndpoint('', 'ACTIVE', 1, 10, '2020-01-01', null, '123abc')).toBe(
        '/ws/fhir2/R4/Encounter?_query=encountersWithMedicationRequests&_getpagesoffset=1&_count=10&status=ACTIVE&location=123abc',
      );
    });
    test('should return endpoint without date but with location and search term parameters', () => {
      expect(getPrescriptionTableEndpoint('', 'ACTIVE', 1, 10, '2020-01-01', 'bob', '123abc')).toBe(
        '/ws/fhir2/R4/Encounter?_query=encountersWithMedicationRequests&_getpagesoffset=1&_count=10&status=ACTIVE&patientSearchTerm=bob&location=123abc',
      );
    });
    ...
    test('should return endpoint with multiple comma-separated location parameters', () => {
      expect(getPrescriptionTableEndpoint('', 'ACTIVE', 1, 10, '2020-01-01', 'bob', '123abc,456def')).toBe(
        '/ws/fhir2/R4/Encounter?_query=encountersWithMedicationRequests&_getpagesoffset=1&_count=10&status=ACTIVE&patientSearchTerm=bob&location=123abc,456def',
      );
    });
