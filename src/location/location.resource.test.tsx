...
const pharmacyConfig: PharmacyConfig = {
  ...
  locationBehavior: {
    ...
    locationFilter: {
      ...
      useAssociatedPharmacyLocation: true,
...
describe('useLocations', () => {
  ...
  it('should parse into Locations Array', () => {
    ...
    expect(locations[0].associatedPharmacyLocation).toContain('84b9b680-786c-4388-9e7c-805614c13b5a');
    expect(locations[1].id).toBe('318bb1dc-77e3-4ac4-b524-cef0e8a456bd');
    expect(locations[1].name).toBe('KGH MCH Main Pharmacy');
    expect(locations[1].associatedPharmacyLocation).toEqual([]);
